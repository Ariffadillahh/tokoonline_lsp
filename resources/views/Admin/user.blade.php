                ...
                <ul class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Users
                        ...
                        <tbody>
                            ...
                            @forelse ($user as $item)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <img class="w-10 h-10 " src="{{ asset('storage/' . $item->image) }}"
                                            alt="user photo">
                                    </td>
                                    <td class="px-6 py-4 ">
                                        ...
                                        <button data-modal-target="{{ $item->id }}"
                                            data-modal-toggle="{{ $item->id }}" class="text-red-600" type="button">
                                            Hapus
                                        </button>

        ...
        @if (count($alamat) < 3)
            <div class="flex justify-end">
                <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                    class="btn  rounded  my-2 btn-outline btn-primary">Tambah Alamat</button>
            </div>
        @else
                        ...
                        <div class="border w-full rounded shadow-md border-red-900 ">
                            <div class="p-3">
                                ...
                                <div class="flex gap-4 justify-end">
                                    <div>
                                        <button data-modal-target="hapus{{ $item->id_alamat }}"
                                            data-modal-toggle="hapus{{ $item->id_alamat }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline text-lg"
                                            type="button">
                                            <i
                                    ...
                                    <div>
                                        <button data-modal-target="{{ $item->id_alamat }}"
                                            data-modal-toggle="{{ $item->id_alamat }}" class="text-red-500 text-lg"
                                            type="button">
                                ...
                                {{-- Hapus Modal --}}
                                <div id="{{ $item->id_alamat }}" tabindex="-1"
                                    class="hidden overflow-y-auto overflow-x-hidden  bg-black/20 h-full fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full ">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <button type="button"
                                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                data-modal-hide="{{ $item->id_alamat }}">
                                ...
                                {{-- Modal Update --}}
                                <div id="hapus{{ $item->id_alamat }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-modal-hide="hapus{{ $item->id_alamat }}">
                                                    <svg class="w-3 h-3" aria-hidden="true"
                                                        xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round"
                                                            ...
                                                            <div class="w-full">
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="namap"
                                                                        name="namap" required  value="{{$item->name_penerima}}"
                                                            ...
                                                            <div class="w-full">
                                                                <div>
                                                                    ...
                                                                    <input type="number" id="No Handphone"
                                                                        name="nohp" required value="{{$item->no_hp}}"
                                                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="w-full">
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="Provinsi"
                                                                        name="provinsi" required value="{{$item->name_provinsi}}"
                                                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                </div>
                                                            </div>
                                                            <div class="w-full">
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="Kota"
                                                                        name="kota" required value="{{$item->name_kota}}"
                                                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="w-full">
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="Kecamatan"
                                                                        name="kecamatan" required value="{{$item->name_kecamatan}}"
                                                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                </div>
                                                            </div>
                                                            <div class="w-full">
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="Kelurahan"
                                                                        name="kelurahan" required value="{{$item->name_kelurahan}}"
                                                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="id" value="{{ $item->id_alamat }}">
                                                        <label for="message"
